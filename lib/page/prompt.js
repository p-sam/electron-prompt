...
function formToJSON(form) {
	return [].reduce.call(form.querySelectorAll("input"), (data, element) => {
...
function promptSubmit() {
	...
	} else if(promptOptions.type === "html") {
		data = JSON.stringify(formToJSON(document.querySelector('#data-container')));
	}
...
function promptRegister() {
	...
	if (promptOptions.type === 'html') {
		dataContainerElement.innerHTML = promptOptions.inputHtml;
	} else {
		let dataElement;
		if (promptOptions.type === 'input') {
