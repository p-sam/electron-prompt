...
function electronPrompt(options, parentWindow) {
	return new Promise((resolve, reject) => {
		...
		if (options_.type === 'html' && (options_.inputHtml === null || typeof options_.inputHtml !== 'string')) {
			return reject(new Error('"inputHtml" must be a stringt'));
		}
